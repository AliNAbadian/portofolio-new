...
const SwarmCursor = ({
  ...
  useEffect(() => {
    ...
    const pointer = { clientX: cssW * 0.5, clientY: cssH * 0.5, has: false };
    ...
    const applyPointerToCursor = () => {
      if (!pointer.has) return;
      const r = container.getBoundingClientRect();
      cursor.x = pointer.clientX - r.left;
      cursor.y = pointer.clientY - r.top;
      cursor.has = true;
    };
