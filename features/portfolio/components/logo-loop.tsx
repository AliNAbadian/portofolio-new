...
import type { LogoItem, LogoLoopProps } from "../model/logo-loop.types";

export type { LogoItem, LogoLoopProps } from "../model/logo-loop.types";
  ...
  ({
    ...
    const rootClasses = useMemo(
      () =>
        cx(
          "relative group",
          isVertical ? "overflow-hidden h-full inline-block" : "w-full overflow-x-hidden",
          "[--logoloop-gap:32px]",
          ...
          return (
            <li
              className={cx(
                ...
                isVertical ? "mb-[var(--logoloop-gap)]" : "me-[var(--logoloop-gap)]",
